...
const ChatBot: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: 'Hello! I\'m your store assistant. I can help you with product questions, order status, and provide insights about your business. How can I help you today?',
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {!isFloatingOpen ? (
          <button
            ...
            className="w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all transform hover:scale-105"
          >
